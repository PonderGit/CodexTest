...
OUT.mkdir(exist_ok=True)
(OUT/f"c18_batch3_shard{shard}.json").write_bytes(pretty)
(OUT/f"c18_batch3_shard{shard}.sha256").write_text(sha(canon)+"  canonical-json\n",encoding="utf-8")
print(json.dumps({
 "batch":"B003",
 "shard":shard,
 "rows":len(results),
